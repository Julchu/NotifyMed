...
//		coder.encode(voiceRecording, forKey: Keys.voiceRecording)
    ...
    init?(medicineName: String, days: [Bool], frequency: String, startDate: Date, endDate: Date, dismissed: Bool, audioName: String) {
...
//		let voiceRecordingDecoded = (decoder.decodeObject(forKey: Keys.voiceRecording) as? NSURL)!
        ...
        self.init(medicineName: medicineNameDecoded, days: daysDecoded, frequency: frequencyDecoded , startDate: startDateDecoded , endDate: endDateDecoded, dismissed: dismissedDecoded, audioName: audioNameDecoded )
	}
